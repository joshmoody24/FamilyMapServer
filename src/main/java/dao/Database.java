...
/**
 * Represents the SQLite database and handles opening and closing connections to it.
 */
public class Database {
     ...
     * @return an object representing the connection to the database
     ...
     * @param commit if true, commits all changes made to the database. If false, roll back changes
     */
